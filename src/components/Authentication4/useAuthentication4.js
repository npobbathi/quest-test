...
import useAuthentication4ResponsiveSize from './useAuthentication4ResponsiveSize';
...
const useAuthentication4 = () => {
  const [currentVariant, setCurrentVariant] = React.useState(
    variantOptions['ScreenDesktop']
  );

  const breakpointsVariant = useAuthentication4ResponsiveSize();
...
export default useAuthentication4;
