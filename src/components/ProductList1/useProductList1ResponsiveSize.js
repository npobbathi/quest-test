...
const useProductList1ResponsiveSize = () => {
  ...
  React.useEffect(() => {
    ...
    const ScreenMobileSize = window.matchMedia('(max-width: 690px)');
    ...
    const ScreenTabletSize = window.matchMedia(
      '(min-width: 691px) and (max-width: 1090px)'
    );
...
export default useProductList1ResponsiveSize;
