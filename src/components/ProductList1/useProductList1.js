...
import useProductList1ResponsiveSize from './useProductList1ResponsiveSize';
...
const useProductList1 = () => {
  const [currentVariant, setCurrentVariant] = React.useState(
    variantOptions['ScreenDesktop']
  );

  const breakpointsVariant = useProductList1ResponsiveSize();
...
export default useProductList1;
